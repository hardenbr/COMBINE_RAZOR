...
#lumi_text.AddText("T5gg: pp#rightarrow #tilde{g}#tilde{g} #rightarrow (#tilde{\chi}^{0}_{1} #rightarrow #tilde{G} #gamma) (#tilde{\chi}^{0}_{1} #rightarrow #tilde{G} #gamma) + jet(s)")
...
exp_hist.GetXaxis().SetTitle("m_{#tilde{g}} [GeV]")
exp_hist.GetYaxis().SetTitle("m_{#tilde{#chi}^{0}_{1}} [GeV]")
exp_hist.SetMinimum(.5)
exp_hist.Draw("colz")
...
leg =  rt.TLegend(.58,.7,.88,.95,"Razor #gamma#gamma + #geq 1 jet: #sigma_{exp} Excluded (fb)")
leg.SetTextSize(.03)
