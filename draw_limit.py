...
lumi_text.AddText("GGM Bino like #tilde{#chi}^{0}: pp#rightarrow #tilde{g} #tilde{g} #rightarrow (#tilde{\chi}^{0}#rightarrow #tilde{G}#gamma) (#tilde{\chi}^{0}#rightarrow #tilde{G}#gamma) + jet(s)")
...
leg =  rt.TLegend(.58,.7,.88,.95,"Razor: #gamma#gamma + #geq 1 jet")
leg.AddEntry(exp_0, "Exp. Exclusion","l")
leg.AddEntry(exp, "Exp. Exclusion 95% Conf.","f")
leg.AddEntry(obs, "Observed Exclusion","l")
leg.SetFillColor(0)
leg.SetLineWidth(4)
leg.Draw()
